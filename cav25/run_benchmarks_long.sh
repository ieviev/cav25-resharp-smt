...
mkdir -p results/
$DOCKER_CMD /bin/bash -c '/run_bench.sh sygus_qgen denghang automatark boolean_and_loops date det_blowup password regexlib_membership regexlib_intersection regexlib_subset state_space'
